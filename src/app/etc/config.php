...
return [
    'modules' => [
        ...
        'Biztech_Ausposteparcel' => 1,
        'Bss_AdminActionLog' => 1,
        'Bss_ImportExportCore' => 1,
        'Bss_OrderAmount' => 1,
        'Bss_OrderAmountGraphQl' => 1,
        'Bss_OrderImportExport' => 1,
        'Bss_ProductAttachment' => 1,
        'Bss_ProductAttachmentGraphQl' => 1,
        'GlobalColours_ExtensionsPatcher' => 1,
        'GlobalColours_Importer' => 1,
        'GlobalColours_Init' => 1,
        'Mageplaza_Core' => 1,
        'StripeIntegration_Payments' => 1,
        'GlobalColours_WpAuth' => 1,
        'Klaviyo_Reclaim' => 1,
        'Machship_Fusedship' => 1,
        'MageMe_Core' => 1,
        'MageMe_WebForms' => 1,
        'MageMe_WebFormsCustomerRegistration' => 1,
        'MageMe_WebFormsGraphQl' => 1,
        'MageMe_WebFormsZoho' => 1,
        'Mageplaza_AutoRelated' => 1,
        'Mageplaza_AutoRelatedGraphQl' => 1,
        'Mageplaza_StoreCredit' => 1,
        'Mageplaza_StoreCreditGraphQl' => 1,
        'GlobalColours_Overrides' => 1,
        'Mageplaza_ZohoCRM' => 1,
        'Meetanshi_Extensions' => 1,
        'Meetanshi_ShippingRestrictions' => 1,
        'Meetanshi_ShippingRules' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'GlobalColours_Stripe' => 1,
