...
class ActionInfo
{
    ...
    {
        if (strpos($fullActionName, 'adminhtml') === 0) {
            $fullAction = substr($fullActionName, strpos($fullActionName, '_') + 1);
        } else {
            $fullAction = $fullActionName;
        }
        $arrAction = explode('_', $fullAction);
        $label = ucfirst($arrAction[0]);
        $groupName = $arrAction[0];
        for ($i = 1; $i < count($arrAction) - 1; $i++) {
            $label .= " " . ucfirst($arrAction[$i]);
            $groupName .= "_" . $arrAction[$i];
        }
        if (strpos($groupName, 'reports') === 0 || strpos($groupName, 'rating') === 0) {
            $groupName = substr($groupName, 0, strpos($groupName, '_'));
        }
        foreach ($this->toArray() as $key => $value) {
            if (strcmp($value['group_name'], $groupName) == 0) {
                if (array_key_exists('expected_models', $value)) {
                    $expectedModel = $value['expected_models'];
                } else {
                    $expectedModel = '';
                }
                break;
        ...
        $action = $arrAction[count($arrAction) - 1];
        $action = (str_contains(strtolower($action), 'save')) ? 'save' : $action;
        return [
            $fullActionName => [
                'label' => $label,
                'group_name' => $groupName,
                'action' => $action,
                'controller_action' => $fullActionName,
                'expected_models' => $expectedModel
            ]
        ];
    }
    ...
    public function toArray()
    {
        return [
            'catalog_product_edit' => [
                    ...
                    'group_name' => 'catalog_product',
                    'action' => 'view',
                    'controller_action' => 'catalog_product_edit',
                    'expected_models' => 'Magento\\Catalog\\Model\\Product',
                ],
            'catalog_product_addAttributeToTemplate' => [
                    'label' => 'Catalog Products',
                    'group_name' => 'catalog_product',
                    'action' => 'addAttributeToTemplate',
                    'controller_action' => 'catalog_product_addAttributeToTemplate',
                    'expected_models' => 'Magento\\Catalog\\Model\\Product',
                ],
            'catalog_product_alertsPriceGrid' => [
                    'label' => 'Catalog Products',
                    'group_name' => 'catalog_product',
                    'action' => 'alertsPriceGrid',
                    'controller_action' => 'catalog_product_alertsPriceGrid',
                    'expected_models' => 'Magento\\Catalog\\Model\\Product',
                ],
            'catalog_product_alertsStockGrid' => [
                    'label' => 'Catalog Products',
                    'group_name' => 'catalog_product',
                    'action' => 'alertsStockGrid',
                    'controller_action' => 'catalog_product_alertsStockGrid',
                    'expected_models' => 'Magento\\Catalog\\Model\\Product',
                ],
            'catalog_product_categories' => [
                    ...
                    'group_name' => 'catalog_product',
                    'action' => 'categories',
                    'controller_action' => 'catalog_product_categories',
                    'expected_models' => 'Magento\\Catalog\\Model\\Product',
                ],
            ...
            'review_rating_index' => [
                'label' => 'Catalog Ratings',
                'group_name' => 'review_rating',
                'action' => 'view',
                'controller_action' => 'review_rating',
                'expected_models' => 'Magento\\Review\\Model\\Rating',
            ],
            'review_product_edit' => [
                    'label' => 'Catalog Reviews',
                    'group_name' => 'review_product',
                    'action' => 'view',
            ...
            'catalog_product_attribute_edit' => [
                    ...
                    'group_name' => 'catalog_product_attribute',
                    'action' => 'view',
            ...
            'catalog_product_set_edit' => [
                    ...
                    'group_name' => 'catalog_product_set',
                    'action' => 'view',
            ...
            'mui_export_gridToXml' => [
                    ...
                    'group_name' => 'customer_index',
                    'action' => 'export',
                    'controller_action' => 'mui_export_gridToXml',
                    'expected_models' => 'Magento\\Customer\\Model\\Customer',
                ],
            'mui_export_gridToCsv' => [
                    ...
                    'group_name' => 'customer_index',
                    'action' => 'export',
                    'controller_action' => 'mui_export_gridToCsv',
                    'expected_models' => 'Magento\\Customer\\Model\\Customer',
                ],
            ...
            'reports_report_statistics_refreshRecent' => [
                    'label' => 'Reports Refresh Recent',
                    'group_name' => 'reports',
                    'action' => 'freshRecent',
                    'controller_action' => 'reports_report_statistics_refreshRecent',
                ],
            ...
            'catalog_rule_promo_catalog_edit' => [
                    ...
                    'group_name' => 'catalog_rule_promo_catalog',
                    'action' => 'view',
            ...
            'catalog_promo_quote_edit' => [
                    ...
                    'group_name' => 'catalog_promo_quote',
                    'action' => 'view',
            ...
            'queue:consumers:start' => [
                ...
                'group_name' => 'catalog_promo_quote',
                'action' => 'cron',
                'controller_action' => 'queue:consumers:start',
                'expected_models' => 'Magento\\SalesRule\\Model\\Service\\CouponManagementService',
            ],
            'sales_rule_promo_quote_couponsMassDelete' => [
                'label' => 'Cart Price Rules',
                'group_name' => 'catalog_promo_quote',
                'action' => 'massDelete',
                'controller_action' => 'sales_rule_promo_quote_couponsMassDelete',
                'expected_models' => 'Magento\\SalesRule\\Model\\Service\\CouponManagementService',
            ],
            'adminhtml_system_account_index' => [
                    'label' => 'Admin My Account',
                    'group_name' => 'system_account',
                    'action' => 'view',
            ...
            'newsletter_template_edit' => [
                    'label' => 'Newsletter Templates',
                    'group_name' => 'newsletter_template',
                    'action' => 'view',
            ...
            'newsletter_subscriber_massUnsubscribe' => [
                    ...
                    'group_name' => 'newsletter_subscriber',
                    'action' => 'massUpdate',
            ...
            'sales_order_shipment_view' => [
                    'label' => 'Sales Shipments',
                    'group_name' => 'sales_order_shipment',
                    'action' => 'view',
            ...
            'sales_order_creditmemo_view' => [
                    'label' => 'Sales Credit Memos',
                    'group_name' => 'sales_order_creditmemo',
                    'action' => 'view',
            ...
            'adminhtml_system_store_editStore' => [
                    'label' => 'Manage Stores',
                    'group_name' => 'system_store_groups',
                    'action' => 'view',
            ...
            'theme_design_config_index' => [
                    'label' => 'Theme Design Config',
                    'group_name' => 'theme_design_config',
                    'action' => 'view',
                    'controller_action' => 'theme_design_config_index',
                    'expected_models' => 'Magento\\Theme\\Model\\Design',
                ],
            'theme_design_config_save' => [
                    'label' => 'Theme Design Config',
                    'group_name' => 'theme_design_config',
                    'action' => 'save',
                    'controller_action' => 'theme_design_config_save',
                    'post_dispatch' => 'DesignTheme'
                ],
            'adminhtml_system_currency_saveRates' => [
                    'label' => 'Manage Currency Rates',
                    'group_name' => 'system_currency',
                    'action' => 'save',
            ...
            'search_term_save' => [
                    ...
                    'action' => 'save',
                    'controller_action' => 'search_term_save',
                    'expected_models' => 'Magento\\Search\\Model\\Query'
                ]
        ];
    }
