...
class AusposteParcel extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements CarrierInterface
{
    ...
    {  
        ...
        $length = (round($length) < 5 && $this->scopeConfig->getValue('carriers/ausposteParcel/auspost_allow_default', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)) ? 5 : $length;
        $width = (round($width) < 5 && $this->scopeConfig->getValue('carriers/ausposteParcel/auspost_allow_default', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)) ? 5 : $width;
        $height = (round($height) < 5 && $this->scopeConfig->getValue('carriers/ausposteParcel/auspost_allow_default', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)) ? 5 : $height;
        ...
        if ($country == 'AU') {
            ...
            if (isset($responseData->errors)) {
                ...
                $selectedfreeshipping = explode(",", $freeshipmethod);
