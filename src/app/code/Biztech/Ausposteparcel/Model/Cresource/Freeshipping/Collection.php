...
namespace Biztech\Ausposteparcel\Model\Cresource\Freeshipping;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        //parent::_construct();
        //$this->_init('ausposteParcel/freeshipping');
        $this->_init('Biztech\Ausposteparcel\Model\Freeshipping', 'Biztech\Ausposteparcel\Model\Cresource\Freeshipping');
    }
}
