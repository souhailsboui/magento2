...
class Api extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function sendConsignment($consignmentId = null, $orderId = null, $returnLabels = 0)
    {
        ...
        if (strlen($shippingAddress['company']!=null?$shippingAddress['company']:'') > 40) {
    ...
    public function getShipmentRates($products, $fromPostcode, $toPostcode, $city, $regioncode, $items)
    {
        ...
        $sname = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressName', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressName', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
