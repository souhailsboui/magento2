...
class Standalone extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function createShipmentReqeustToeParcel($shipmentData = array(), $consignment_result, $shippingMethod, $customer_detail, $country)
    {
        $response = array();
    ...
    public function createMultipleShipmentReqeustToeParcel($shipmentData = array(), $consignment_result, $customer_detail)
    {
        $response = array();
        $shipment_data = json_encode($shipmentData);
        $account_no = $customer_detail["account_number"];
