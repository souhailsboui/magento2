...
class Standalone extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getCustomerData() {
        ...
        $globalData['returnAddressName'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressName', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressName', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnAddressLine1'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressLine1', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressLine1', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnAddressLine2'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressLine2', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressLine2', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnAddressLine3'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressLine3', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressLine3', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnAddressLine4'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressLine4', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressLine4', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnCountryCode'] = 'AU';
        $globalData['returnPostcode'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressPostcode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressPostcode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnStateCode'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressStateCode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressStateCode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnSuburb'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressSuburb', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressSuburb', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnAddressPhone'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressPhone', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressPhone', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $globalData['returnAddressEmail'] = trim($this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressEmail', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/returnAddressEmail', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
