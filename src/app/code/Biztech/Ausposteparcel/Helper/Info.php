...
class Info extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getOrderWeight($order)
    {
        ...
        $product_unit = trim($this->scopeConfig->getValue('carriers/ausposteParcel/productWeightUnit', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/productWeightUnit', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        $packaging_allowance_type = trim($this->scopeConfig->getValue('carriers/ausposteParcel/packagingAllowanceType', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/packagingAllowanceType', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
        if ($weight > 0 && $product_unit == 'grams') {
            $weight = $weight / 1000;
            $weight = number_format($weight, 2, '.', '');
        }

        $packaging_allowance_value = trim($this->scopeConfig->getValue('carriers/ausposteParcel/packagingAllowanceValue', \Magento\Store\Model\ScopeInterface::SCOPE_STORE)!=null?$this->scopeConfig->getValue('carriers/ausposteParcel/packagingAllowanceValue', \Magento\Store\Model\ScopeInterface::SCOPE_STORE):'');
