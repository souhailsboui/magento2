...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous source.
    ...
    var contrastColor = function (backgroundColor) {
        var color = backgroundColor;
        if (typeof backgroundColor === "string") {
            color = (backgroundColor.charAt(0) === '#') ? hexToRgb(backgroundColor) : hexToRgb('#' + backgroundColor);
        }
