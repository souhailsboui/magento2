...
namespace MageMe\WebForms\Ui\Component\Fieldset\Listing\Column;
...
class Actions extends Column
{
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                $item[$this->getData('name')]['edit'] = [
                    'href' => $this->getEditUrl($item[FieldsetInterface::ID], $storeId),
                    'label' => __('Edit'),
                    'hidden' => false,
                    '__disableTmpl' => true
                ];
    ...
    protected function getEditUrl(int $id, int $storeId): string
    {
        return $this->urlBuilder->getUrl(
            ...
            [FieldsetInterface::ID => $id, 'store' => $storeId]
        );
    }
}
