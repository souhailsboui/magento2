...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Manage Quick Response Categories'), __('Manage Quick Response Categories'));
        $resultPage->getConfig()->getTitle()->prepend(__('Manage Quick Response Categories'));
