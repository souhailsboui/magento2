...
class MarkRead extends Action
{
    ...
    public function execute()
    {
        ...
        if (!$id) {
            ...
            $this->messageManager->addErrorMessage(__('We can\'t find a result.'));
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('The result has been marked as read.'));
            return $resultRedirect->setPath('*/*/', [FormInterface::ID => $result->getFormId()]);
        } catch (Exception $e) {
            ...
            return $resultRedirect->setPath('*/*/', [ResultInterface::ID => $id]);
        }
    }
