...
namespace MageMe\WebForms\Model\ResourceModel\FileCustomerNotification;
...
class Collection extends AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init(FileCustomerNotification::class, FileCustomerNotificationResource::class);
    }
}
