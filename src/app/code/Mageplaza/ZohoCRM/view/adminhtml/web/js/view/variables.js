...
define([
    ...
    window.ZohoVariables = {
        ...
        prepareVariableRow: function (varValue, varLabel) {
            return '<span class="mp-zoho-on-click" onclick="'+ this.insertFunction(varValue) +'">' + varLabel + '</span>';
        },
        ...
        insertFunction: function (value) {
            return 'ZohoVariables.insertVariable(&apos;' + value + '&apos;)';
        },
