...
use Mageplaza\StoreCredit\Api\Data\OrderInterface;
...
class Order extends SalesOrder implements OrderInterface
{
    ...
    {
        return $this->getData(self::MP_STORE_CREDIT_EXTRA_CONTENT);
    }
    ...
    {
        return $this->setData(self::MP_STORE_CREDIT_EXTRA_CONTENT, $value);
    }
}
